...
stat_recurrency = ["pt","pt","pt","pt","pt","pt","ps","ps","gm","gm","gm","pt","pt","pt","gm","gm","gm","gm","gm","gm"] # ps=ps+pt+gm, pt=pt+gm, gm=gm
...
t_stat_names = ["special_line","lineup","blocks","tovs","break","clutch_point","start_offensive_pt","offensive_ps","scored_us","scored_ps","score_us_ps","score_opp_ps","set_play_o","d_tactic","negative_hystory","positive_hystory","assistmen","scorer","tot_blocks","tot_tovs","ht_blocks","ht_tovs","tot_break_us","tot_break_opp","ht_break_us","ht_break_opp","final_score_us","final_score_opp","ht_score_us","ht_score_opp"]
t_stat_recurrency = ["pt","pt","pt","pt","pt","pt","pt","ps","pt","ps","ps","ps","pt","pt","pt","pt","ps","ps","gm","gm","gm","gm","gm","gm","gm","gm","gm","gm","gm","gm"] # lineup is per point, we still don't manage perfectly the injury subs
t_stat_dtype = ["bool","[7]","int","int","bool","bool","bool","bool","bool","bool","int","int","string","string","string","string","int","int","int","int","int","int","int","int","int","int","int","int","int","int"]
...
#     list(pt_player_stats.to_list()[0:6]) + #TODO: change base stats to game
#     list(ps_player_stats.to_list()) + # assist, score
#     list(points_player.columns[10:]) # pss_o,d,tot, game_id
# )
...
points_team.insert(1, 'In Campo', in_campo)
